      ...
      {isOpen && (
        ...
        >
          <motion.div 
            ...
            className="bg-paper border-4 border-ink w-full max-w-md shadow-[12px_12px_0_0_rgba(20,20,20,1)] relative"
          >
            ...
            <div className="p-6 border-b-2 border-ink bg-white relative z-10">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 bg-paper bg-[radial-gradient(#d5d5d5_1px,transparent_1px)] [background-size:16px_16px] relative z-0">
              <div>
                ...
                <input 
                  required
                  type="text" 
                  className="w-full border-2 border-ink bg-white px-3 py-3 font-mono font-medium focus:outline-none focus:bg-[#f0ff00] transition-colors rounded-none placeholder:text-ink/30 relative z-0"
                  placeholder="_"
                  value={formData.name}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select 
                    className="w-full border-2 border-ink bg-white px-3 py-3 font-mono font-medium focus:outline-none focus:bg-[#f0ff00] transition-colors rounded-none appearance-none relative z-0"
